...
QVector<std::tuple<QString, QString>> Articolo::get_autori() {return autori_articolo;}
...
void Articolo::set_autori(QVector<std::tuple<QString, QString>> a) {autori_articolo = a;}
